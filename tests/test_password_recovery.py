...
class TestPasswordRecovery:
    ...
    def test_redirect_to_password_recovery_page(self, driver):
        ...
        assert password_recovery_page.find_the_element(5, PasswordRecoveryPageLocators.RESET_BUTTON).is_displayed(), \
    ...
    def test_redirect_to_password_reset_page(self, driver):
        ...
        assert password_recovery_page.find_the_element(5, PasswordRecoveryPageLocators.SAVE_BUTTON).is_displayed(), \
