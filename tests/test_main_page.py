...
class TestMainPage:
    ...
    def test_get_ingredient_details(self, driver):
        ...
        assert base_page.find_the_element(5, MainPageLocators.INGREDIENT_DETAILS_TITLE).is_displayed(), \
    ...
    def test_close_ingredient_details_window(self, driver):
        ...
        main_page.click_on_ingredient()
        base_page = BasePage(driver)
        base_page.wait_until_element_visibility(5, MainPageLocators.INGREDIENT_DETAILS_TITLE)
        main_page.click_on_close_button()

        assert base_page.wait_until_element_invisibility(5, MainPageLocators.INGREDIENT_DETAILS_MODAL), \
    ...
    def test_successful_order(self, driver, login):
        ...
        base_page.find_the_element(10, MainPageLocators.ORDER_BUTTON)
        main_page.click_on_order_button()
        base_page.wait_until_element_visibility(10, MainPageLocators.ORDER_NUMBER)

        assert base_page.find_the_element(5, MainPageLocators.ORDER_STATUS_TEXT).is_displayed(), \
